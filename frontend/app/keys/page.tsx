...
export default function KeysPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-3xl font-bold">Ключи</h2>
        <p className="text-gray-500">Управление SSH-ключами</p>
      </div>
      ...
      <div className="panel">
        ...
        <form onSubmit={generateKey} className="grid md:grid-cols-4 gap-4 items-end">
          ...
          <label className="label">
            Тип ключа
            <select className="input" name="key_type" defaultValue="ed25519">
        ...
        {generatedKey && (
          <div className="mt-4 p-4 border border-gray-200 rounded-xl bg-white">
            <p className="text-sm">
              <strong>Ключ создан:</strong> {generatedKey.name} ({generatedKey.key_type})
            </p>
            ...
            <div className="flex gap-3 mt-3">
              <button className="btn-secondary" onClick={copyGenerated}>
                <Copy size={16} /> Копировать
              </button>
              <button className="btn-secondary" onClick={downloadGenerated}>
