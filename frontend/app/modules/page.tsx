    ...
    <div className="space-y-6">
      ...
      <div className="panel">
        <div className="flex items-center gap-1 border-b border-gray-200 dark:border-gray-700 mb-4">
          <button
            onClick={() => setModTab("builtin")}
            className={`px-4 py-2 text-sm font-semibold border-b-2 -mb-px transition-colors ${
              modTab === "builtin" ? "border-blue-600 text-blue-600" : "border-transparent text-gray-500 hover:text-gray-700"
            }`}
          >
            Встроенные модули
          </button>
          <button
            onClick={() => setModTab("user")}
            className={`px-4 py-2 text-sm font-semibold border-b-2 -mb-px transition-colors ${
              modTab === "user" ? "border-blue-600 text-blue-600" : "border-transparent text-gray-500 hover:text-gray-700"
            }`}
          >
