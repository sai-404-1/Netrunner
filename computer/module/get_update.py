# from . import Modules, LocalComputer
from . import Modules
from .local_executor import LocalComputer
...
class UserModule:
    web_ui_visible = False

    def __init__(self):
        self.title = "Найти обновления"
        self.description = "Поиск обновлений"
