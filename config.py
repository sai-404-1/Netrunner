...
# Каталог для скриншотов рабочего стола хостов (превью в UI). Один файл на
# хост, каждый снимок перезаписывает предыдущий — истории снимков нет.
SCREENSHOTS_PATH = os.environ.get("NETRUNNER_SCREENSHOTS_PATH", "data/screenshots")
